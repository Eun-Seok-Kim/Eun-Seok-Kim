...
<form>
  ...
  <div id="box">
        <div class="panel panel-primary">
	      <div class="panel-heading"><h3>답글쓰기</h3></div>
	      <div class="panel-body">
	          <table class="table">
	              <tr>
	                 <th width="10%">제목</th>
	                 <td><input name="b_subject"  style="width: 100%;"></td>
	              </tr>
	              ...
	              <tr>
	                 <td colspan="2" align="center">
	                      <input class="btn  btn-primary" type="button"  value="답글쓰기" onclick="send(this.form);">
